...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#saveBundActivityBtn").click(function () {
			...
			//发送请求
			$.ajax({
				url:'workbench/clue/saveBoundActivity.do',
				data:ids,
				type:'post',
				dataType:'json',
				success:function (data) {
		...
		$("#relationTBody").on("click","a",function () {
			...
			if (window.confirm("确定解除吗？")){
				//发送请求
				$.ajax({
					url:'workbench/clue/saveUnboundActivity.do',
					data:{
...
<body>
	...
	<div style="position: relative; top: 40px; left: 40px;">
		...
		<div class="remarkDiv" style="height: 60px;">
			...
			<div style="position: relative; top: -40px; left: 40px;" >
				<h5>哎呦！</h5>
				<font color="gray">线索</font> <font color="gray">-</font> <b>李四先生-meiming</b> <small style="color: gray;"> 2017-01-22 10:10:10 由zhangsan</small>
		...
		<div class="remarkDiv" style="height: 60px;">
			...
			<div style="position: relative; top: -40px; left: 40px;" >
				<h5>呵呵！</h5>
				<font color="gray">线索</font> <font color="gray">-</font> <b>李四先生-meiming</b> <small style="color: gray;"> 2017-01-22 10:20:10 由zhangsan</small>
				<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">
					<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #E6E6E6;"></span></a>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #E6E6E6;"></span></a>
